...
public class ATM {
	...
	// string ist der typ des Keys (kontonummer als text), Integer ist der typ des
	// wertes (kontostand als zahl)
	...
	public ATM() {
		// ein fester kontoinhaber mit der kontonummer 190723101542, hat 4215€ auf dem
		// konto
